#!/usr/bin/env python3
"""
Simple test runner for Genie tools integration tests.
...
def run_genie_tests():
    """Run Genie integration tests and display results"""
    print("=" * 60)
    print("GENIE TOOLS INTEGRATION TESTS")
    print("=" * 60)
    ...
    suite = loader.discover(os.path.join(project_root, 'tests/integration'), pattern='test_genie_tools.py')
